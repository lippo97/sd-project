...
fun goalHandler(
    ...
    Router.router(vertx).apply {
        ...
        get("/")
            .produces(mimeSerializer.availableTypes)
            .useCaseHandler(mimeSerializer) {
        ...
        get("/:name")
            .produces(mimeSerializer.availableTypes)
            .useCaseHandler(mimeSerializer) { ctx ->
        ...
        post("/")
            ...
            .produces(mimeSerializer.availableTypes)
            .useCaseHandler(mimeSerializer, HTTPStatusCode.CREATED) { ctx ->
